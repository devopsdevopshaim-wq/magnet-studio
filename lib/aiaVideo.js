...
const CONFIG = path.join(__dirname, "..", "data", "aia-video-config.json");
...
module.exports = { providerList, saveProvider, submit, attachUpload, jobState, buildPrompt, exportPrompt, PROVIDERS };
